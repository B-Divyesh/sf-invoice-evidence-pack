...
Audited 30 August 2026 against the empty first screen at `/`. Button labels,
fact fragments, captions, assurance text, and footer copy are included because
a visitor can read or rely on them. No line exceeds 22 words. No banned word is
present.
...
| The optional paid entitlement | license |
